...
var projects = [{
  ...
  owner: 'userTwo',
  company: 'companyOne',
  userStories: ['company1project1us1', 'company1project1us2'],
...
var userStories = [{
  ...
  finishedCondition: ['Tener un carrito de compras', 'Tener pasarela de pagos'],
  priority: 70,
  cost: 50,
  owner: 'userThree',
  project: 'projectOne',
  tickets: ['company1project1us1t1']
}, {
  ...
  finishedCondition: ['Base de datos no relacional para múltiples consultas', 'Cargar al menos 5 productos'],
  priority: 90,
  cost: 35,
  owner: 'userThree',
  project: 'projectOne',
  tickets: ['company1project1us2t1', 'company1project1us2t2']
}];
var tickets = [{
