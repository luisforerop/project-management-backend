import { projects, users, companies } from "../db";
...
export const devsInACompany = ({companyId}) => {
    const { users } = companies.find(company => company.id === companyId)
    return infoTeam({team: users})
} 
